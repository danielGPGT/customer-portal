    ...
    <Card className="border-2 bg-gradient-to-r from-amber-50 via-amber-50/80 to-orange-50 dark:from-amber-950/40 dark:via-amber-900/20 dark:to-orange-950/40">
      <CardContent className="flex flex-col gap-3 p-4 md:flex-row md:items-center md:justify-between">
        <div className="flex items-start gap-3">
          <div className="mt-0.5 flex h-9 w-9 items-center justify-center rounded-full bg-amber-500/10 text-amber-700 dark:text-amber-300">
            <Gift className="h-5 w-5" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <h3 className="text-sm font-semibold">Invite friends, earn rewards</h3>
              <Badge
                variant="outline"
                className="border-amber-300/60 bg-amber-100/80 text-[10px] font-semibold uppercase tracking-wide text-amber-900 dark:border-amber-700/60 dark:bg-amber-900/40 dark:text-amber-100"
              >
                Referral
              </Badge>
            </div>
