-- Quick fix: Add SECURITY DEFINER to process_referral_signup function
-- This allows the function to bypass RLS when inserting into referrals and notifications

-- Drop and recreate with SECURITY DEFINER
DROP FUNCTION IF EXISTS process_referral_signup(TEXT, UUID, TEXT, TEXT, TEXT, TEXT, UUID) CASCADE;
